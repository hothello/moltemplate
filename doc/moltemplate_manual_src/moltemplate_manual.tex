...
write("Postprocess") {
	...
	set ATOM mol1[2]/H1 type @atom:OPLSAA/98
	SET ATOM mol1[2]/H2 TYPE @atom:OPLSAA/98
	SET atom mol1[2]/H3 TYPE @atom:OPLSAA/98
	set atom mol1[2]/C2 type @atom:OPLSAA/96
	set atom mol1[2]/H4 type @atom:OPLSAA/97
}
\end{verbatim}
...
write_once("Postprocess") {
	set atom mol0[*][*][2]/ben type @atom:ROD/b1
	set atom mol0[*][*][2]/ben shape 2.5 2.5 6.5
}
\end{verbatim}
